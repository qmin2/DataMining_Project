...
class PaperDataset(Dataset):
    def __init__(self, args, df, tokenizer):
        ...
        use_cache = True \
            if os.path.isfile("../data/labels.npy") and os.path.isfile("../data/input_ids.npy") and os.path.isfile("../data/attention_mask.npy") \
            else False
...
class ClusteringEvaluator():
    def __init__(self, sentences, labels, clustering_batch_size=500, batch_size=64, limit=None):
